...
class Beta {
  ...
  Tensor get concentration0 => Tensor.reader.vTableGet(_bc, _bcOffset, 4, null);
  Tensor get concentration1 => Tensor.reader.vTableGet(_bc, _bcOffset, 6, null);

  @override
  String toString() {
    return 'Beta{concentration0: $concentration0, concentration1: $concentration1}';
  }
}
...
class BetaObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(
    ...
    if (concentration0Offset != null) {
      fbBuilder.addOffset(0, concentration0Offset);
    }
    if (concentration1Offset != null) {
      fbBuilder.addOffset(1, concentration1Offset);
    }
    return fbBuilder.endTable();
  }
...
class LogNormal {
  ...
  @override
  String toString() {
    return 'LogNormal{mean: $mean, stddev: $stddev}';
  }
}
