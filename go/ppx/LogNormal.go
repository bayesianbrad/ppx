...
func (rcv *LogNormal) Mean(obj *Tensor) *Tensor {
...
func (rcv *LogNormal) Stddev(obj *Tensor) *Tensor {
...
func LogNormalAddMean(builder *flatbuffers.Builder, mean flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(mean), 0)
}
func LogNormalAddStddev(builder *flatbuffers.Builder, stddev flatbuffers.UOffsetT) {
