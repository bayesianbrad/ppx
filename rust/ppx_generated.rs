...
const ENUM_MAX_MESSAGE_BODY: u8 = 11;
...
#[allow(non_camel_case_types)]
const ENUM_VALUES_MESSAGE_BODY:[MessageBody; 12] = [
  MessageBody::NONE,
...
#[allow(non_camel_case_types)]
const ENUM_NAMES_MESSAGE_BODY:[&'static str; 12] = [
    "NONE",
    "Handshake",
    "HandshakeResult",
    "Run",
...
impl<'a> Sample<'a> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn distribution_as_log_normal(&'a self) -> Option<LogNormal> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn distribution_as_exponential(&'a self) -> Option<Exponential> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn distribution_as_weibull(&'a self) -> Option<Weibull> {
...
impl<'a> LogNormal<'a> {
  ...
  #[inline]
  pub fn mean(&self) -> Option<Tensor<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Tensor<'a>>>(LogNormal::VT_MEAN, None)
  }
  #[inline]
  pub fn stddev(&self) -> Option<Tensor<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Tensor<'a>>>(LogNormal::VT_STDDEV, None)
  }
}
...
impl<'a: 'b, 'b> LogNormalBuilder<'a, 'b> {
  #[inline]
  pub fn add_mean(&mut self, mean: flatbuffers::WIPOffset<Tensor<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Tensor>>(LogNormal::VT_MEAN, mean);
  }
  #[inline]
  pub fn add_stddev(&mut self, stddev: flatbuffers::WIPOffset<Tensor<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Tensor>>(LogNormal::VT_STDDEV, stddev);
  }
  #[inline]
